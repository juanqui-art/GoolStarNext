  ...
  try {
      ...
      return {
        ...
        openGraph: {
          ...
          images: [
            ...
            {
              url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://goolstar.vercel.app'}/images/torneos/canchaReflejo.jpg`,
              width: 600,
              height: 600,
        ...
        twitter: {
          ...
          images: ['/images/torneos/torneo-twitter.jpg'],
          creator: '@GoolStarEc',
          site: '@GoolStarEc',
        },
        alternates: {
    ...
    return {
      ...
      twitter: {
        ...
        images: ['/images/torneos/canchaReflejo.jpg'],
        creator: '@GoolStarEc',
        site: '@GoolStarEc',
      },
      alternates: {
