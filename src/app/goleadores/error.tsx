...
export default function GoleadoresError({ error, reset }: ErrorProps) {
    useEffect(() => {
        // Log del error para debugging
        console.error('Error en página de goleadores:', error);
    }, [error]);
        ...
        <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 flex items-center justify-center px-4">
            <div className="max-w-md w-full bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-8 text-center">
                ...
                <p className="text-neutral-600 dark:text-neutral-400 mb-6">
                    Ha ocurrido un problema al cargar la información de los goleadores.
