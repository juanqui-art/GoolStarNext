    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-8">
          <button className="bg-goal-blue hover:bg-goal-blue/90 text-white font-semibold py-2 px-6 rounded-full transition-all duration-300 transform hover:scale-105 shadow-sm">
            Ver próximos partidos
          </button>
          <button className="bg-white dark:bg-neutral-800 border border-goal-gold hover:border-goal-gold/80 text-neutral-800 dark:text-neutral-200 font-semibold py-2 px-6 rounded-full transition-all duration-300 shadow-sm">
